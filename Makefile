...
deploy:
	@forge script script/DeployHigherOrLower.s.sol:DeployHigherOrLower --rpc-url $(RPC_URL) --account sepolia_key --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvvv
